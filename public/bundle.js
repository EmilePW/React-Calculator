...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Operator = __webpack_require__(168);

	var _Operator2 = _interopRequireDefault(_Operator);

	var _Screen = __webpack_require__(169);

	var _Screen2 = _interopRequireDefault(_Screen);

	var _NumberInput = __webpack_require__(170);

	var _NumberInput2 = _interopRequireDefault(_NumberInput);

	var _Decimal = __webpack_require__(171);

	var _Decimal2 = _interopRequireDefault(_Decimal);

	var _Equals = __webpack_require__(172);

	var _Equals2 = _interopRequireDefault(_Equals);

	var _Delete = __webpack_require__(173);

	var _Delete2 = _interopRequireDefault(_Delete);

	var _Reset = __webpack_require__(174);
	...
	var Calculator = function (_React$Component) {
		...
		_createClass(Calculator, [{
			...
			value: function calculate() {
				...
				var newCalcArray = this.state.calcArray;

				// Loop through order of operations
				for (var currentOpOrder = 1; currentOpOrder <= 5; currentOpOrder++) {
					for (var j = 0; j < this.state.calcArray.length; j++) {
						// Check for operator
						if (isNaN(this.state.calcArray[j])) {
							var currOperator = this.state.calcArray[j];
							var prevNumber = this.state.calcArray[j - 1];
							var nextNumber = this.state.calcArray[j + 1];
			...
			key: 'onNumberClick',
			value: function onNumberClick(num) {

				// Check whether number is an additional digit or a separate number
				var previousInput = this.state.calcArray[this.state.calcArray.length - 1];

				if (!isNaN(previousInput)) {
					// Concatenate digit
					var newNum = previousInput.toString() + num.toString();
			...
			key: 'onDecimalPlaceClick',
			value: function onDecimalPlaceClick() {
				var previousInput = this.state.calcArray[this.state.calcArray.length - 1];
			...
			key: 'convertDecimals',
			value: function convertDecimals() {
				var newCalcArray = this.state.calcArray;

				newCalcArray.forEach(function (val, i, arr) {
					if (val === ".") {
						var numDecimalPlaces = Math.floor(Math.log10(arr[i + 1])) + 1;
			...
			key: 'onOperatorClick',
			value: function onOperatorClick(operator) {
				var previousInput = this.state.calcArray[this.state.calcArray.length - 1];
			...
			key: 'removeLastInput',
			value: function removeLastInput() {
				var newCalcArray = this.state.calcArray;
				newCalcArray.pop();
			...
			value: function render() {
				...
				var numbers = [];
				for (var i = 9; i >= 0; i--) {
					numbers.push(_react2.default.createElement(_NumberInput2.default, { className: 'number-input', key: Math.random() * (i + 1), onClick: this.onNumberClick.bind(this, i), val: i }));
				}

				var operators = ['+', '-', 'x', '÷', '^'];
				operators = operators.map(function (op) {
					return _react2.default.createElement(_Operator2.default, { className: "operator-input operator-input-" + op, key: Math.random() * 100, onClick: _this2.onOperatorClick.bind(_this2, op), type: op });
				});

				return _react2.default.createElement(
					'div',
					{ className: 'calculator' },
					_react2.default.createElement(_Screen2.default, { output: this.state.display }),
					_react2.default.createElement(
						'section',
						{ className: 'numberPanel' },
						numbers,
						_react2.default.createElement(_Decimal2.default, { onClick: this.onDecimalPlaceClick.bind(this) })
					),
					_react2.default.createElement(
						'section',
					...
					_react2.default.createElement(
						'section',
						{ className: 'evaluatePanel' },
						_react2.default.createElement(_Reset2.default, { onClick: this.reset.bind(this) }),
						_react2.default.createElement(_Delete2.default, { onClick: this.removeLastInput.bind(this) }),
						_react2.default.createElement(_Equals2.default, { onClick: this.calculate.bind(this) })
					)
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Operator = function (_React$Component) {
		...
		function Operator() {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(Operator).call(this));
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Screen = function (_React$Component) {
		...
		function Screen() {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(Screen).call(this));
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NumberInput = function (_React$Component) {
		...
		function NumberInput() {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(NumberInput).call(this));
		}
	...
	NumberInput.propTypes = {
		val: _react2.default.PropTypes.number.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Decimal = function (_React$Component) {
		_inherits(Decimal, _React$Component);

		function Decimal() {
			_classCallCheck(this, Decimal);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(Decimal).call(this));
		}
		...
		_createClass(Decimal, [{
			...
			value: function render() {
				return _react2.default.createElement(
					"button",
					{ className: "decimal-place-input", onClick: this.props.onClick },
					"."
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Equals = function (_React$Component) {
		_inherits(Equals, _React$Component);

		function Equals() {
			_classCallCheck(this, Equals);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(Equals).call(this));
		}
		...
		_createClass(Equals, [{
			...
			value: function render() {
				return _react2.default.createElement(
					"button",
					{ className: "equals", onClick: this.props.onClick },
					"="
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Delete = function (_React$Component) {
		...
		function Delete() {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(Delete).call(this));
		}
		...
		_createClass(Delete, [{
			...
			value: function render() {
				return _react2.default.createElement(
					"button",
					{ className: "delete", onClick: this.props.onClick },
					"Del"
				);
			}
		}]);
	...
	var Reset = function (_React$Component) {
		...
		_createClass(Reset, [{
			...
			value: function render() {
				return _react2.default.createElement(
					"button",
					{ className: "reset", onClick: this.props.onClick },
					"Reset"
				);
			}
		}]);
